...
public:
  ...
  inline void setpast() { sec = HPTR_SEC_MIN; subsec = 0.; }
  inline void setfuture() { sec = HPTR_SEC_MAX; subsec = 0.; }
...
public:
  ...
  inline double unpackinday() const {return (sec+subsec)/86400.;}
  inline void setmin() { day = HPTR_DAY_MIN; sec = 0, subsec = 0.; }
  inline void setmax() { day = HPTR_DAY_MAX; sec = 0, subsec = 0.; }
  inline void setpast() { day = HPTR_DAY_MIN; sec = 0, subsec = 0.; }
  inline void setfuture() { day = HPTR_DAY_MAX; sec = 0, subsec = 0.; }
...
public:
  ...
  inline void setpast() { date = HPTR_DATE_MIN; sec = 0, subsec = 0.; }
  inline void setfuture() { date = HPTR_DATE_MAX; sec = 0, subsec = 0.; }
...
#if defined hpatimer_cc || defined include_once_h
//******************************************************************

Tunix_t::Tunix_t(double _tsec) {
  setnow(); add(_tsec);
}


Ttai_t::Ttai_t(double _tsec) {
  setnow(); add(_tsec);
}


Tmjd_t::Tmjd_t(double _tsec) {
  setnow(); add(_tsec);
}


Ttt_t::Ttt_t(double _tsec) {
  setnow(); add(_tsec);
}


Tdate_t::Tdate_t(double _tsec) {
  setnow(); add(_tsec);
}
